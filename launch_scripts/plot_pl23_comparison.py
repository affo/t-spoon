...
if __name__ == '__main__':
    ...
    tp = tp[(tp.strategy == 'LB-PL3') | (tp.strategy == 'TO-PL2') | (tp.strategy == 'TO-PL3')]
    ...
    savefig('pl23_comparison_tp', fig)

    # ------ latency
    lat = aggr[(aggr.tag1 == 'ks') & (aggr.tag3 == 'lat_stable')]
    lat = lat[(lat.strategy == 'LB-PL3') | (lat.strategy == 'TO-PL2') | (lat.strategy == 'TO-PL3')]
    ...
    ax.set_xscale('log')
    plt.gca().invert_xaxis()
    savefig('pl23_comparison_lat', fig)
