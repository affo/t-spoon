...
if __name__ == '__main__':
    ...
    # ------ throughput
    tp = aggr[(aggr.tag1 == 'ks') & (aggr.tag3 == 'tp_stable') & (aggr.isolationLevel == 'PL3')]
    ...
    savefig('pl3_comparison_tp', fig)

    # ------ latency
    lat = aggr[(aggr.tag1 == 'ks') & (aggr.tag3 == 'lat_stable') & (aggr.isolationLevel == 'PL3')]
    ...
    ax.set_xscale('log')
    plt.gca().invert_xaxis()
    savefig('pl3_comparison_lat', fig)
